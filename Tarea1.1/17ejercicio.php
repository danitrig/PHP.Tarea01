...
/*Ejercicio 17. Implemente un script PHP que defina tres variables, una tipo array, 
 * otra tipo string y otra boleana,  *  que imprima un mensaje indicando el tipo
 *  de variable del que sea cada una de ellas.*/
